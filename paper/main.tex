...
\emph{how many}. LOF achieves a higher AUC ($0.983$) than
SybilCore on this corpus; we attribute this to the small test set
($N = 78$) where LOF's local density estimation on the
$11$-dimensional feature vector is well-suited. Whether this
advantage holds on larger corpora is an open question.
